...
if __name__ == '__main__':
    ...
    locations = dict(A=(1,8),B=(4,8),C=(10,8),
                     D=(15,8),E=(19,8),F=(9,5),
                     G=(11,6),H=(1,2),I=(5,2),
                     J=(8,2),K=(13,2),L=(15,2),
                     M=(19,2))
    ...
    graph_problemToStation = GraphProblem(pocetok,stanica,graph_map)
    graph_problemFromStation = GraphProblem(stanica,kraj,graph_map)

    answer1 = astar_search(graph_problemToStation)
    answer2 = astar_search(graph_problemFromStation)

    print(answer1.solve())
    print(answer2.solve())

    sumPathCost = answer1.path_cost + answer2.path_cost
