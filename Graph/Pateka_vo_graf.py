...
if __name__ == '__main__':
    ...
    answer = uniform_cost_search(graph_problem)
    pateka = answer.solve()
    dolzina = answer.path_cost

    graph_problem1 = GraphProblem(Kraj,Pocetok,graph)
    answer1 = uniform_cost_search(graph_problem1)
    pateka1 = answer1.solve()
    dolzina1 = answer1.path_cost

    if dolzina1 < dolzina:
        dolzina = dolzina1
        pateka = pateka1

    if pateka.__contains__(Stanica):
        dolzina -= 9
