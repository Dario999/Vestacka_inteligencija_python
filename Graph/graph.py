...
if __name__ == '__main__':
    ...
    romania_map = UndirectedGraph(dict(
                            ...
                            Iasi=dict(Vislue=92,Neamt=87),
                            Lugoj=dict(Timisoara=111,Mehadia=70),
                            Oradea=dict(Zerind=1,Sibiu=151),
    ...
    romania_problem = GraphProblem('Arad','Buchurest',romania_map)

    answer1 = breadth_first_tree_search(romania_problem)
    print(f'Path: {answer1.solve()}, cost: {answer1.path_cost}')

    '''answer2 = breadth_first_graph_search(romania_problem)
    print(f'Path: {answer2.solve()}, cost: {answer2.path_cost}')

    #answer3 = uniform_cost_search(romania_problem)
    #print(f'Path: {answer3.solve()}, cost: {answer3.path_cost}')

    answer4 = astar_search(romania_problem)
    print(f'Path: {answer4.solve()}, cost: {answer4.path_cost}')'''