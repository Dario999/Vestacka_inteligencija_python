...
Sostojva = (Xk,Yk,Xl,Yl,Lstar) 
Lstar=((X1,Y1),(X2,Y2),(X3,Y3))
...
class Star(Problem):
    ...
    def successor(self, state):
        ...
        star_new = tuple(s for s in stars if s != knight_new)
        state_new = knight_new[0],knight_new[1],bishop[0],bishop[1],star_new
        if state_new != state:
            successors['K1'] = state_new
        ...
        state_new = knight_new[0], knight_new[1], bishop[0], bishop[1], star_new
        if state_new != state:
            successors['K8'] = state_new

        #Bishop type1
        bishop_new = move_bishop_type1(state)
        star_new = tuple(s for s in stars if s != bishop_new)
        state_new = knight[0],knight[1],bishop_new[0],bishop_new[1],star_new
        if state_new != state:
            successors['B1'] = state_new
...
if __name__ == '__main__':
    ...
    stars_position = ((star1_row,star1_column),(star2_row,star2_column),(star3_row,star3_column))

    star = Star((knight_row,knight_column,bishop_row,bishop_column,stars_position))
