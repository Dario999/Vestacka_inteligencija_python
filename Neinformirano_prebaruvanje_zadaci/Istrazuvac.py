    ...
    def successor(self,state):
        ...
        if y < 8:
            ...
            if (x_new != obstacle_1_new[0] or y_new != obstacle_1_new[1]) and \
                    (x_new != obstacle_2_new[0] or y_new != obstacle_2_new[1]):
                state_new = (x_new,y_new,obstacle_2_new[1],obstacle_2_new[2])
...
if __name__ == '__main__':
    ...
    explorer = Explorer((man_row,man_column,1,3,1,6,6,-1),house)
