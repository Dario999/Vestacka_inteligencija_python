...
#GoreC
def GoreC(state):
    covece,box1,box2,box3 = state
    cX = covece[0]
    cY = covece[1]
    x_new = cX - 1
    y_new = cY
    covece_new = (x_new,y_new)
    if ((covece_new != box1 and x_new > 0) and (covece_new != box2 and x_new > 0) and (covece_new != box3 and x_new >= 0)):
        return covece_new,box1,box2,box3
    else:
        return covece,box1,box2,box3
...
def GoreCK(state):
    ...
    if (covece_new == box1 and x_new > 0):
        if (box1[0] > 0):
            ...
            return covece_new,box1_new,box2,box3
        else:
            return covece_new,box1,box2,box3
    elif (covece_new == box2 and x_new > 0):
        if (box2[0] > 0):
            box2_new = (box2[0]-1,box2[1])
            return covece_new,box1,box2_new,box3
        else:
            return covece_new,box1,box2,box3
    elif (covece_new == box3 and x_new > 0):
        if (box3[0] > 0):
            box3_new = (box3[0]-1,box3[1])
            return covece_new,box1,box2,box3_new
        else:
            return covece_new,box1,box2,box3
    else:
        return covece_new, box1, box2, box3
...
def DoluC(state):
    ...
    y_new = cY
    covece_new = (x_new, y_new)
    if ((covece_new != box1 and x_new < 8) and (covece_new != box2 and x_new < 8) and (covece_new != box3 and x_new < 8)):
        return covece_new,box1,box2,box3
    else:
        return covece,box1,box2,box3
...
def DoluCK(state):
    ...
    if (covece_new == box1 and x_new < 7):
        ...
        if (box2[0] < 7):
            ...
            return covece_new, box1, box2, box3
    elif (covece_new == box3 and x_new < 7):
        if (box3[0] < 7):
            box3_new = (box3[0] + 1, box3[1])
            return covece_new, box1, box2, box3_new
        else:
...
def LevoC(state):
    ...
    y_new = cY - 1
    covece_new = (x_new, y_new)
    if ((covece_new != box1 and y_new >= 0) and (covece_new != box2 and y_new >= 0) and (covece_new != box3 and y_new >= 0)):
        return covece_new, box1, box2, box3
    else:
        return covece, box1, box2, box3
...
def LevoCK(state):
    ...
    if (covece_new == box1 and y_new > 0):
        ...
        if (box2[1] > 0):
            ...
            return covece_new, box1, box2, box3
    elif (covece_new == box3 and y_new > 0):
        if (box3[1] > 0):
            box3_new = (box3[0], box3[1] - 1)
            return covece_new, box1, box2, box3_new
        else:
            return covece_new, box1, box2, box3
    else:
...
def DesnoC(state):
    ...
    y_new = cY + 1
    covece_new = (x_new, y_new)
    if ((covece_new != box1 and y_new <= 9) and (covece_new != box2 and y_new <= 9) and (covece_new != box3 and y_new <= 9)):
        return covece_new, box1, box2, box3
    else:
        return covece, box1, box2, box3
...
def DesnoCK(state):
    ...
    if (covece_new == box1 and y_new < 9):
        ...
        if (box2[1] < 9):
            ...
            return covece_new, box1, box2, box3
    elif (covece_new == box3 and y_new < 9):
        if (box3[1] < 9):
            box3_new = (box3[0], box3[1] + 1)
            return covece_new, box1, box2, box3_new
        else:
...
class Kutii(Problem):
    ...
    def goal_test(self, state):
        covece,box1,box2,box3 = state
        if (box1 in goal and box2 in goal and box3 in goal):
            return True
        else:
            return False
